...
@Component
public class PessoaConverter3 implements Converter {
	...
	public Object getAsObject(FacesContext fc, UIComponent uic, String value) {
		...
		if (value != null && value.trim().length() > 0) {
			...
			try {
				...
				// pessoaService = (PessoaService)
				// fc.getExternalContext().getApplicationMap().get("PessoaService");

				return pessoaService.findById(new Long(value));
